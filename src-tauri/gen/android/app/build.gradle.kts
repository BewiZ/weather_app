...
android {
    compileSdk = 36
    namespace = "com.zzz.locate"
    defaultConfig {
        manifestPlaceholders["usesCleartextTraffic"] = "false"
        applicationId = "com.zzz.locate"
        minSdk = 24
        targetSdk = 36
    ...
    buildTypes {
        ...
        getByName("release") {
            ...
            signingConfig = signingConfigs.create("release") {
                storeFile = file("E:/ma/tauri/first/locate/locate-keystore.jks")
                storePassword = "locate2026"
                keyAlias = "locate"
                keyPassword = "locate2026"
            }
            proguardFiles(
